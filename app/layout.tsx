...
import PreloaderOverlay from "@/components/preloader-overlay"
...
export const metadata: Metadata = {
  title: "IZ Design | Marketing de alto impacto para marcas",
  description:
        ...
        <Script id="dynamic-favicon" strategy="beforeInteractive">
          {`
            function updateFavicon() {
              ...
              const faviconHref = darkMode ? '/icons/iz-design-white.svg' : '/icons/favicon-dark.svg';

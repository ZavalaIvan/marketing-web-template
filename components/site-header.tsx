  ...
  const services = [
    {
      ...
      label: "Render IZ Design",
      icon: Building2,
      description: "Visuales arquitectonicos fotorrealistas",
    },
    {
      href: "/3d-product-rendering",
      label: "Render de Producto 3D",
      icon: Package,
      description: "Piezas de producto listas para marketing",
    },
    {
      href: "/",
      label: "Animacion 3D de Producto",
      icon: Package,
      description: "Storytelling visual para vender mas",
    },
  ]
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="liquid-glass border-gray-800 p-0 w-64 flex flex-col">
                ...
                <div className="flex items-center gap-1.5 px-4 py-4 border-b border-gray-800">
                  ...
                  <span className="font-semibold tracking-wide text-white text-lg">IZ Design</span>
                </div>
